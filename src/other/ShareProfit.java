...
public class ShareProfit {
    ...
    public static int maxProfit(int price[], int n) {
        ...
        // Get the maximum profit with two transactions allowed After this loop, profit[n-1] contains the
        // result
    ...
    public static void main(String args[]) {
        int price[] = {236, -340, -46, 371, 418, -242, -462, -342, 399, -98, 453, 487, -276, -352, -5, 51, -221, -455, 93, 213, -298, 284, 344, -439, 60, -285, 83, 398, -92, 182, 279, 499, -360, 487, -301, -113, 117, -172, 440, 235, -72, 443, -491, -365, -366, -66, 67, -3};
        int n = price.length;
