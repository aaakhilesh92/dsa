...
public class MaxSumLessThanEqualToK {

    // To find subarray with maximum sum less than or equal to sum
    static int findMaxSubarraySum(int arr[], int n, int sum) {
        // To store current sum and max sum of subarrays
