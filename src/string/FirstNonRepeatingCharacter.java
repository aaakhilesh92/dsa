...
public class FirstNonRepeatingCharacter {
    ...
    static void getCharCountArray(String str) {
        for (int i = 0; i < str.length(); i++) {
            ...
            } else { // If it's first occurrence, then store the index and count = 1
    ...
    /*
     * The method returns index of first non-repeating character in a string. If all characters are
