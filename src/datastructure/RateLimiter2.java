...
public class RateLimiter2 {
    ...
    public static void main(String[] args) {
        ...
        inputs.add(new Input("A", 1102));
        inputs.add(new Input("A", 1103));
    ...
    public static boolean isAllowed(String clientId, long timeOfHit) {
        ...
        if (holder.containsKey(clientId)) {
            // client has hit before, keep polling the queue till you reach a time whose diff with timeOfHit is
            // less than 1000
