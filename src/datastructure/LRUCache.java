...
public class LRUCache {
    ...
    public void refer(int page) {
        ...
        } else {// The found page may not be always the last element, even if it's an intermediate element
                // that needs to be removed and added to the start of the Queue
